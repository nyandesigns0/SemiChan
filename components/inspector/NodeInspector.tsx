  ...
  if (node.type === "juror") {
    ...
    return (
      <div className="flex flex-col gap-8 w-full pb-8">
        ...
        <div className="w-full">
          <div className="mb-4">
            <h3 className="text-lg font-black text-slate-900 uppercase tracking-tight">Associated Sentences</h3>
            <p className="text-xs text-slate-500 font-medium">Full list of evidence linked to this juror</p>
          </div>
    ...
    return (
      <div className="flex flex-col gap-6 w-full pb-8">
        {/* Concept Insight Summary Panel */}
        <div className="rounded-2xl border-2 border-indigo-100 bg-gradient-to-r from-indigo-50/50 to-purple-50/50 p-6 shadow-md">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="rounded-xl bg-indigo-600 p-2 text-white shadow-lg shadow-indigo-200">
                <Badge variant="outline" className="border-none p-0 text-white">
                  AI
                </Badge>
              </div>
              <div>
                <h3 className="text-sm font-bold text-indigo-900 uppercase tracking-wider">Concept Insight</h3>
                <p className="text-[10px] text-indigo-500 font-medium">Synthesized from juror feedback</p>
              </div>
            </div>
            {insight?.isLoadingSummary && (
              <Badge variant="secondary" className="animate-pulse bg-indigo-100 text-indigo-700 border-none">
                Analyzing...
              </Badge>
            )}
          </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Generated Title</div>
            ...
            <div>
              <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">One-Line Synthesis</div>
              {insight?.isLoadingSummary ? (
                ...
                <div className="py-2">
                  <Button 
                    variant="outline" 
                    size="sm"
                    className="group px-5 py-2.5 border-indigo-200 bg-white/50 text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all shadow-sm h-auto"
                    onClick={() => onFetchSummary?.(node.id)}
                  >
                    <Sparkles className="mr-2 h-3.5 w-3.5 transition-transform group-hover:rotate-12" />
                    <span className="text-xs font-bold">Synthesize with AI</span>
                  </Button>
        ...
        <div className="w-full">
          <div className="mb-4">
            <h3 className="text-lg font-black text-slate-900 uppercase tracking-tight">Associated Sentences</h3>
            <p className="text-xs text-slate-500 font-medium">Full list of evidence linked to this concept (including soft matches)</p>
          </div>
